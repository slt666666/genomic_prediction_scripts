...
# calc correlation coefficient between onserved & predicted values
...
# calc correlation coefficient between onserved & predicted values for each RIL
...
# Training ElasticNet model to apply other population
def train_Enet_for_app(test_data, train_data, params):
